  ...
  */
  ...
  Assert.prototype = {
    ...
    */
    ...
    Fullname: function () {
          this.__class__ = 'Fullname';
          this.validate = function ( value ) {
              var regExp = /^[A-Za-z\_\-\.\s\xF1\xD1]+$/;
              if ( 'string' !== typeof value )
                  throw new Violation( this, value, { value: Validator.errorCode.must_be_a_string } );
              if ( !regExp.test( value ) )
                  throw new Violation( this, value );
      ...
      type: function (type) {
        ...
        switch (type) {
          ...
          case 'alphanum':
            ...
            break;
          case 'fullname':
                assert = new Validator.Assert().Fullname();
                break;
            case 'CodigoPostal':
                assert = new Validator.Assert().CodigoPostal();
                break;
          case 'url':
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
      ...
      fullname:     "Tiene que contener solo letras.",
      CodigoPostal:     "Tiene que contener codigo postal valido."
  },
