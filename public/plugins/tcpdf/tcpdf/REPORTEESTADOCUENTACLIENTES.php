...
class REPORTEESTADOCUENTACLIENTES extends TCPDF {
    ...
    public function setLogoCorona($logo){


        $this->logoCorona=$logo;
    }

    //Page header
    public function Header() {
        // Logo   dirname(__FILE__).'/../images/'
      //  $image_file = K_PATH_IMAGES.'logo_example.jpg';
        if($this->logoCorona==1){
            $image_file = public_path().'/img/logocorona.jpg';
            $this->Image($image_file, 30, 3, 28, '', 'JPG', '', 'C', false, 300, '', false, false, 0, false, false, false);
        }
