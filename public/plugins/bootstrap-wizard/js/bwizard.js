...
(
    function(b,e)
    {
        ...
        b.widget=function(g,j,f)
        {
            ...
            i.prototype=b.widget.extend(k,{widgetEventPrefix:g},f,{constructor:i,namespace:h,widgetName:g,widgetBaseClass:m,widgetFullName:m});
        ...
        b.widget.bridge=function(g,f)
        {
            ...
            b.fn[g]=function(k)
            {
                var i=typeof k==="string",j=d.call(arguments,1),l=this;k=!i&&j.length?b.widget.extend.apply(null,[k].concat(j)):k;
                ...
                if(i)
                {
                    this.each(function()
                    {
                        ...
                        if(n!==m&&n!==e)
                        {
                            l=n&&n.jquery?l.pushStack(n.get()):n;return false
                        }
                    })
                }
