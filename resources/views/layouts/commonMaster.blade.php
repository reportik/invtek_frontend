...
<head>
  ...
  <style>
    ...
    .nav-align-top>.nav-link, .nav-align-right>.nav-link, .nav-align-bottom>.nav-link, .nav-align-left>.nav-link {
    color: #fff;
    }
    .nav-align-top>.nav-link.active, .nav-align-right>.nav-link.active, .nav-align-bottom>.nav-link.active, .nav-align-left>.nav-link.active {
    color: #59981A;
    }
    .nav-align-top>.nav-link:hover, .nav-align-right>.nav-link:hover, .nav-align-bottom>.nav-link:hover, .nav-align-left>.nav-link:hover {
    color: #fff;
    } 
    .nav-align-top>.nav-link:focus, .nav-align-right>.nav-link:focus, .nav-align-bottom>.nav-link:focus, .nav-align-left>.nav-link:focus {
    color: #fff;
    }
    .nav-align-top>.nav-link:active, .nav-align-right>.nav-link:active, .nav-align-bottom>.nav-link:active, .nav-align-left>.nav-link:active {
    color: #fff;
    }
    .nav-align-top>.nav-link:disabled, .nav-align-right>.nav-link:disabled, .nav-align-bottom>.nav-link:disabled, .nav-align-left>.nav-link:disabled {
    color: #fff;
    }
    .nav-align-top>.nav-link:visited, .nav-align-right>.nav-link:visited, .nav-align-bottom>.nav-link:visited, .nav-align-left>.nav-link:visited {
    color: #fff;
    }
    .nav-align-top>.nav-link:target, .nav-align-right>.nav-link:target, .nav-align-bottom>.nav-link:target, .nav-align-left>.nav-link:target {
    color: #fff;
    }
    .nav-align-top>.nav-link:link, .nav-align-right>.nav-link:link, .nav-align-bottom>.nav-link:link, .nav-align-left>.nav-link:link {
    color: #fff;
    }
    .nav-align-top>.nav-link:hover, .nav-align-right>.nav-link:hover, .nav-align-bottom>.nav-link:hover, .nav-align-left>.nav-link:hover {
      color: #fff;
