...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    ...
    <a href="javascript:void(0);" class="layout-menu-toggle menu-link text-large ms-auto"> <i
        class="bi bi-chevron-left menu-toggle-icon d-xl-block align-middle"></i> </a>
  </div>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ $activeClass }}">
      <a href="{{ isset($menu->url) ? url($menu->url) : 'javascript:void(0);' }}"
        ...
        <i class="{{ $menu->icon }}"></i>
        @endisset
        <div style="white-space:initial">{{ isset($menu->name) ? __($menu->name) : '' }}</div>
        @isset($menu->badge)
