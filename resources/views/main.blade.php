  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-resumen"
        aria-controls="navs-top-resumen" aria-selected="false">Resumen</button>
    </li>
    <li class="nav-item">
      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-payment"
        aria-controls="navs-top-payment" aria-selected="false">Método de Pago</button>
    </li>
  </ul>
                  ...
                  <div class="row g-4">
                    ...
                    <div class="col mt-2">
                      ...
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="collapsible-address-type-office"> Oficina (Entrega de 9
                          AM
                          a 5 PM) </label>
                      </div>
                    </div>
